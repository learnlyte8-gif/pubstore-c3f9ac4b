...
export default function Terms() {
  return (
    ...
    >
      ...
      <h2 className="text-xl font-bold mt-8 mb-3">9. Promote &amp; Earn (promoter terms)</h2>
      <p>
        Promote &amp; Earn lets any registered user share products using a personal link and earn a commission when their link leads to a completed sale. Commission rates are set by the seller of each product, shown before you share, and may change for future sales at any time.
      </p>
      <p>
        Attribution: the most recent promoter link a shopper opens is credited for up to 7 days and survives sign-in. Only one promoter is credited per item. You may not earn commission on your own purchases, on purchases you make on behalf of a buyer, or on orders that are cancelled or refunded.
      </p>
      <p>
        Payment: a commission is recorded as pending when an order is placed, confirmed when the buyer confirms delivery, and becomes available for withdrawal after the seller's release period (7 days unless stated otherwise). Available commission can be moved to your PUBSTORE wallet subject to a minimum withdrawal amount and identity verification. Refunds, chargebacks, or cancelled orders reverse the related commission.
      </p>
      <p>
        Conduct: you must not use spam, misleading claims, fake accounts, bots, click farms, paid search on PUBSTORE brand terms, coupon or cashback abuse, or any misrepresentation of prices, availability, or your relationship with PUBSTORE. We may withhold, reverse, or cancel commissions, place an account on hold, or remove a promoter from the programme where we detect abuse or a breach of these Terms. You are responsible for any taxes on your earnings.
      </p>

      <h2 className="text-xl font-bold mt-8 mb-3">10. Rides, logistics, and services</h2>
      <p>
      ...
      <h2 className="text-xl font-bold mt-8 mb-3">12. Intellectual property</h2>
      <p>
      ...
      <h2 className="text-xl font-bold mt-8 mb-3">13. Dispute resolution</h2>
      <p>
      ...
      <h2 className="text-xl font-bold mt-8 mb-3">15. Termination and suspension</h2>
      <p>
      ...
      <h2 className="text-xl font-bold mt-8 mb-3">16. Changes to these Terms</h2>
      <p>
      ...
      <h2 className="text-xl font-bold mt-8 mb-3">17. Contact us</h2>
      <p>
