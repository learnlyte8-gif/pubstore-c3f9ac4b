...
export const CATEGORIES: Category[] = [
  ...
  { id: "toys", name: "Toys & Games", icon: ToyBrick },
  ...
  { id: "camera", name: "Cameras & Photo", icon: Camera },
  { id: "gaming", name: "Gaming", icon: Gamepad2 },
  { id: "jewelry", name: "Jewelry", icon: Gem },
  { id: "watches", name: "Watches", icon: Watch },
  { id: "eyewear", name: "Eyewear", icon: Glasses },
  { id: "bags", name: "Bags & Luggage", icon: Wallet },
  { id: "stationery", name: "Stationery", icon: Scissors },
  { id: "garden", name: "Garden & Plants", icon: Flower2 },
  { id: "outdoor", name: "Outdoor & Camping", icon: Tent },
  { id: "bikes", name: "Bikes & Scooters", icon: Bike },
  { id: "tv-audio", name: "TV & Audio", icon: Tv },
  { id: "computers", name: "Computers", icon: Laptop },
  { id: "audio", name: "Audio & Headphones", icon: Headphones },
  { id: "printers", name: "Printers & Ink", icon: Printer },
  { id: "batteries", name: "Batteries & Power", icon: BatteryCharging },
  { id: "auto-parts", name: "Auto Parts", icon: Cog },
  { id: "fuel-energy", name: "Fuel & Energy", icon: Fuel },
  { id: "logistics", name: "Logistics", icon: Truck },
  { id: "pharmacy", name: "Pharmacy", icon: Pill },
  { id: "measuring", name: "Measuring & Layout", icon: Ruler },
  { id: "landscaping", name: "Landscaping", icon: Shovel },
];
